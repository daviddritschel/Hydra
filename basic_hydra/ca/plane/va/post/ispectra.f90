...
implicit none
 ...
 !Physical arrays:
double precision::  hh(ng,ng), zz(ng,ng), dd(ng,ng), gg(ng,ng), pn(ng,ng)
...
open(75,file='evolution/pnnorm.asc',status='replace')
...
do
  ...
  rms=sqrt(dsumi*sum(pn**2))
  write(75,'(f9.2,1x,e14.7)') t,rms
...
write(*,*)
write(*,*) ' Norms of various fields (full, balanced and imbalanced) are in'
write(*,*) ' znorms.asc, dnorms.asc, gnorms.asc, hnorms.asc & pnorms.asc'
write(*,*) ' in the evolution subdirectory.'
write(*,*)
