...
integer,parameter:: npm=500*nx*ny
...
double precision,parameter:: srwfm=beta*kd/(one+kdsq)
...
logical,parameter:: beffect=(beta .ne. zero),btropic=(kd .eq. zero)
...
logical,parameter:: forcing=(fbase .gt. zero)
