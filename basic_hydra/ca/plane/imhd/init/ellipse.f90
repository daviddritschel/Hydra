...
write(*,*) ' Mean radius of the vortex?'
read(*,*) r

write(*,*) ' y:x aspect ratio?'
read(*,*) ellasp
...
!-------------------------------------------------------------------
if (tracer) then
   !Add a tracer contour (the edge of the ellipse) to monitor
   !circulation and its time rate of change:
