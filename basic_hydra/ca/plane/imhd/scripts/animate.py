...
#=====================================================================
#   Animates data in any .r4 file over a selected time range
...
prefix_in=input('File prefix (before .r4, default qq)? ')
prefix=str(prefix_in or 'qq')
dataset=prefix+'.r4'

# Get final frame from chosen dataset:
record2_def=os.path.getsize(dataset)/frame_bytes-1

record1_in=input(' First record to read (default 0)? ')
record1=int(record1_in or 0)
record2_in=input(' Last record to read (default '+str(record2_def)+')? '))
record2=int(record2_in or record2_def)
