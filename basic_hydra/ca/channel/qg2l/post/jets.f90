...
!  |  yeq.r4       - y_e(q,t) in both layers; plot using "yeqview"           |
...
open(21,file='qq1.r4',form='unformatted', &
    & access='direct',status='old',recl=nbytes)
open(22,file='qq2.r4',form='unformatted', &
    & access='direct',status='old',recl=nbytes)
 
 !Open output files:
open(31,file='jets.asc',status='replace')
open(32,file='qvar.asc',status='replace')
open(41,file='yeq.r4',form='unformatted',access='direct', &
                 &  status='replace',recl=4*(1+4*ny))
open(42,file='pdf.r4',form='unformatted',access='direct', &
                 &  status='replace',recl=4*(1+4*ny))
open(61,file='hov1.r4',form='unformatted',access='stream',status='replace')
open(62,file='hov2.r4',form='unformatted',access='stream',status='replace')
t=0.
write(61) t
write(62) t
...
open(20,file='ipdf1.asc',status='replace')
do m=1,ndiv
...
open(20,file='ipdf2.asc',status='replace')
do m=1,ndiv
  write(20,'(1x,f9.7,3(1x,f9.5))') div*(float(m)-0.5), &
...
write(*,*)
write(*,*) ' See yeqview for y_e(q,t) vs t and pdfview for p_q(y) vs t'
write(*,*)
write(*,*) ' See yeqview for y_e(q,t) vs t and pdfview for p_q(y) vs t'
write(*,*)
...
loop=loop-1
open(66,file='hov-plotting',status='replace')
write(66,*) &
...
write(66,*)
write(* ,*)
write(66,'(a,i5,1x,i4)') ' dataview hov1.r4 -ndim ',loop,ny+1
write(* ,'(a,i5,1x,i4)') ' dataview hov1.r4 -ndim ',loop,ny+1
write(66,*)
write(* ,*)
write(66,'(a,i5,1x,i4)') ' dataview hov2.r4 -ndim ',loop,ny+1
write(* ,'(a,i5,1x,i4)') ' dataview hov2.r4 -ndim ',loop,ny+1
write(66,*)
write(* ,*)
close(66)
