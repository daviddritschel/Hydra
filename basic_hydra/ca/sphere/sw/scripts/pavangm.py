...
# This script time-averaged angular momentum in table.txt in a chosen manner
...
kd, rth, brms, tb, njet, aam = np.loadtxt(in_file,dtype=float,unpack=True)
in_file.close()
nd=len(kd)
...
print()
print(' (1) A vs 1/tau for two selected values of b_rms')
print(' (2) A vs 1/tau for two selected values of t_b')
print(' (3) A vs b_rms for two selected values of tau')
print(' (4) A vs b_rms for two selected values of t_b')
print(' (5) A vs t_b for two selected values of b_rms')
print(' (6) A vs t_b for two selected values of tau')
...
if fopt==1:
   ...
   ax.set_ylabel('${\mathcal{A}}$', fontsize=30)
   ...
   outfile='angm_vs_rth_for_tb'+str(tb0)+'kd'+str(kd0)+'.eps'
   ...
   ax.legend(loc='upper left',prop={'size':25})
   outfile='angm_vs_rth_for_brms'+str(brms0)+'kd'+str(kd0)+'.eps'
   ...
   outfile='angm_vs_brms_for_tb'+str(tb0)+'kd'+str(kd0)+'.eps'
   ...
   ax.legend(loc='center right',prop={'size':25})
   outfile='angm_vs_brms_for_tau'+str(tau0)+'kd'+str(kd0)+'.eps'
   ...
   ax.legend(loc='center right',prop={'size':25})
   outfile='angm_vs_tb_for_tau'+str(tau0)+'kd'+str(kd0)+'.eps'
   ...
   outfile='angm_vs_tb_for_brms'+str(brms0)+'kd'+str(kd0)+'.eps'
