...
# Work out the overall max value:
zmin=0.0
zmax=np.amax(Z)
...
im1=ax1.imshow(Z.T,cmap=cm.binary,vmin=zmin,vmax=zmax,extent=(0.0,tmax,-np.pi/2.0,np.pi/2.0),origin='lower',interpolation='bilinear',aspect='auto')
...
#=========================================================================
# Save image:
fig1.savefig('hovg.eps', format='eps', dpi=300)
